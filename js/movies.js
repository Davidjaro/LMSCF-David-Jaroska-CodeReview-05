...
for (let i=0; i < movies.length; i++){
	...
	$(".movies").append(` 
		<div class="col-12 col-sm-6 col-lg-4 mb-4 mt-2 ">
            <div class="movieframe text-white">
                <div class="container-fluid">
                    <div class="row bg-secondary">
                        <div class="col-5 p-2">
                            <img class="rounded border movieposter" src="${movies[i].img}" alt="">
                        </div>
                        <div class="col-7 d-flex flex-column">
                            ...
                            <button class="bg-transparent thumbbtn border-0 ml-auto mt-auto p-0 mb-3 d-flex pr-4">
                                ...
                                <img class="pr-4 d-inline likepic" src="img/likebtn.svg" alt="">
